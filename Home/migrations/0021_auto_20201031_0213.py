# Generated by Django 3.1 on 2020-10-30 18:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='post',
            name='flat_type',
            field=models.CharField(choices=[('Studio Apartment', 'Studio Apartment'), ('2-Room Flat', '2-Room Flat'), ('3-Room Flat', '3-Room Flat'), ('4-Room Flat', '4-Room Flat'), ('5-Room Flat', '5-Room Flat'), ('Executive Flat', 'Executive Flat')], default='2-Room Flat', max_length=20, validators=[Home.models.validate_flat]),
        ),
        migrations.AlterField(
            model_name='post',
            name='town',
